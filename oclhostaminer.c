...
const char *version = hostaGEN_VERSION;
const int debug = 0;
...
{
	fprintf(stderr,
"oclhostaMiner %s (" OPENSSL_VERSION_TEXT ")\n"
"Usage: %s -u <URL> -a <credit address>\n"
"Organized hosta address mining client using OpenCL.  Contacts the specified\n"
...
"              TIP: For pay-per-share hosta pools, set interval\n"
